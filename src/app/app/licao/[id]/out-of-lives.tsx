...
export function OutOfLives({ livesRegenAt }: Props) {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col px-6 py-8">
      ...
      <Link
        href="/app"
        className="btn-3d [--btn-rim:#005a23] mt-8 flex h-14 items-center justify-center rounded-2xl bg-brand-green font-display text-lg font-semibold text-brand-green-fg"
      >
        Voltar pro início
      </Link>
    </main>
