  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col px-6 py-10">
      ...
      <section className="mt-12 flex flex-1 flex-col justify-center">
        ...
        <Link
          href="/entrar"
          className="btn-3d [--btn-rim:#005a23] mt-12 flex h-14 items-center justify-center rounded-2xl bg-brand-green font-display text-lg font-semibold text-brand-green-fg"
        >
          Bora começar
        </Link>
